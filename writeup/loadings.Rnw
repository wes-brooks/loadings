...
<<label=function_definitions, echo=False, include=False>>=
    ...
    #This function uses the BIC to screen variables, returning the 'step' object.
    stepwise_BIC_ag <- function(target, data, sites)
    {
        ...
        #predictors_raw = predictors_raw[-which(predictors_raw=="area")]
        #predictors_raw = predictors[-which(predictors=="slope")]
    ...
    {
        predictors = c("num_days", "tmax", "tmean", "tmin", "nws_prec", "nws_snow", "antecedent_qbase_quantile", 
    ...
    {
        predictors = c("num_days", "tmax", "tmean", "tmin", "nws_prec", "nws_snow", "total_water", "melt_water", "slope", "area", "antecedent_qbase_quantile",
                       "cos_julian", "sin_julian", "antecedent_tmean", "antecedent_tmax", "antecedent_trange")
        d = data[,c(target, predictors)]
        result = list()
