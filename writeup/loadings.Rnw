...
<<label=major_table,echo=FALSE,results=tex>>=
    ...
    print(xtable(cbind(s,p), caption="Percentage of loading that comes from the biggest ten percent of events at each site.",
                 label="tab:stot", align=c('l', 'c', 'c'), digits=0),
    caption.placement="bottom", hline.after=0 )
@
