...
<<combined_table, include=TRUE, results='asis'>>=
    library(xtable)
...
<<major_table, include=TRUE, results='asis'>>=
    library(xtable)
    ...
    print(xtable(cbind(sediment=s,phosphorus=p), caption="Percentage of loading that comes from the biggest ten percent of events at each site.", label="tab:majorload", align=c('l', 'c', 'c')), caption.placement="bottom", hline.after=0 )
@
...
\begin{table}[h] \small
    ...
    \hline
<<sediment_selection_table, include=TRUE, results='asis'>>=
R2_table(es)
R2_table(js)
R2_table(os)
R2_table(bs)
...
\begin{table}[h] \small
    ...
    \hline
<<phosphorus_selection_table, include=TRUE, results='asis'>>=
R2_table(ep)
R2_table(jp)
R2_table(op)
R2_table(bp)
...
\begin{table}[h] \small
    ...
    \textbf{Sediment} & $R^2$ & Model terms \\
    \hline
<<sediment_selection_table-snow, include=TRUE, results='asis'>>=
R2_table(es_snow2)
R2_table(js_snow2)
R2_table(os_snow2)
R2_table(bs_snow2)
...
\begin{table}[h] \small
    ...
    \textbf{Phosphorus} & $R^2$ & Model terms \\
    \hline
<<phosphorus_selection_table-snow, include=TRUE, results='asis'>>=
R2_table(ep_snow2)
R2_table(jp_snow2)
R2_table(op_snow2)
R2_table(bp_snow2)
...
\begin{table}[h!]\small
    ...
    \begin{tabular}{ll}
        \textbf{Solids} & \\
        \hspace{5mm} Eagle: & \Sexpr{ sanipaste(es$ranked, collapse=", ") }\\
        \hspace{5mm} Joos: & \Sexpr{ sanipaste(js$ranked, collapse=", ") }\\
        \hspace{5mm} Otter: & \Sexpr{ sanipaste(os$ranked, collapse=", ") }\\
        \hspace{5mm} Brewery: & \Sexpr{ sanipaste(bs$ranked, collapse=", ") }\\
        \hspace{5mm} Garfoot: & \Sexpr{ sanipaste(gs$ranked, collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ sanipaste(ks$ranked, collapse=", ") }\\
        \hspace{5mm} Rattlesnake: & \Sexpr{ sanipaste(rs$ranked, collapse=", ") } \\
        \hspace{5mm} Bower: & \Sexpr{ sanipaste(bows$ranked, collapse=", ") }\\
        \hspace{5mm} Aggregate: & \Sexpr{ sanipaste(as$ranked, collapse=", ") }
    \vspace{2mm}\\
        \textbf{Phosphorus} & \\
        \hspace{5mm} Eagle: & \Sexpr{ sanipaste(ep$ranked, collapse=", ") }\\
        \hspace{5mm} Joos: & \Sexpr{ sanipaste(jp$ranked, collapse=", ") }\\
        \hspace{5mm} Otter: & \Sexpr{ sanipaste(op$ranked, collapse=", ") }\\
        \hspace{5mm} Brewery: & \Sexpr{ sanipaste(bp$ranked, collapse=", ") }\\
        \hspace{5mm} Garfoot: & \Sexpr{ sanipaste(gp$ranked, collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ sanipaste(kp$ranked, collapse=", ") }\\
        \hspace{5mm} Rattlenake: & \Sexpr{ sanipaste(rp$ranked, collapse=", ") }\\
        \hspace{5mm} Bower: & \Sexpr{ sanipaste(bowp$ranked, collapse=", ") }\\
        \hspace{5mm} Aggregate: & \Sexpr{ sanipaste(ap$ranked, collapse=", ") }\\
    \end{tabular}
...
\begin{table}[h!]\small
    ...
    \begin{tabular}{ll}
        \textbf{Solids} & \\
        \hspace{5mm} Eagle: & \Sexpr{ sanipaste(es_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Joos: & \Sexpr{ sanipaste(js_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Otter: & \Sexpr{ sanipaste(os_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Brewery: & \Sexpr{ sanipaste(bs_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Garfoot: & \Sexpr{ sanipaste(gs_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ sanipaste(ks_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Rattlesnake: & \Sexpr{ sanipaste(rs_snow2$ranked, collapse=", ") } \\
        \hspace{5mm} Bower: & \Sexpr{ sanipaste(bows_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Aggregate: & \Sexpr{ sanipaste(as_snow2$ranked, collapse=", ") }
    \vspace{2mm}\\
        \textbf{Phosphorus} & \\
        \hspace{5mm} Eagle: & \Sexpr{ sanipaste(ep_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Joos: & \Sexpr{ sanipaste(jp_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Otter: & \Sexpr{ sanipaste(op_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Brewery: & \Sexpr{ sanipaste(bp_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Garfoot: & \Sexpr{ sanipaste(gp_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ sanipaste(kp_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Rattlesnake: & \Sexpr{ sanipaste(rp_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Bower: & \Sexpr{ sanipaste(bowp_snow2$ranked, collapse=", ") }\\
        \hspace{5mm} Aggregate: & \Sexpr{ sanipaste(ap_snow2$ranked, collapse=", ") }\\
    \end{tabular}
...
<<aggregate_sediment_model, include=TRUE, results='asis'>>=
...
<<aggregate_phosphorus_model, include=TRUE, results='asis'>>=
...
<<aggregate_sediment_model_snow, include=TRUE, results='asis'>>=
...
<<aggregate_phosphorus_model_snow, include=TRUE, results='asis'>>=
