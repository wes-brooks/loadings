...
streams = c('eagle', 'joosvalley', 'otter', 'brewery', 'garfoot', 'kuenster')
stream_names = list(eagle='Eagle', joosvalley='Joos', otter='Otter', brewery='Brewery', garfoot='Garfoot', kuenster='Kuenster')
...
layout(matrix(1:length(streams), ceiling(length(streams)/2), 2))
for(stream_name in streams) {
    stream = get(stream_name)
...
#Eagle creek
boxplot(log_stot_tot~snow, data=eagle, bty='n', ylim=yy, cex=0.6, pch=4, boxwex=0.4, frame.plot=F, ylab="log( Sediment Load )", names=event_classes, xlim=c(1,17))
...
#Eagle creek
boxplot(log_ptot_tot~snow, data=eagle, bty='n', ylim=yy, cex=0.6, pch=4, boxwex=0.4, frame.plot=F, ylab="log( Phosphorus Load )", names=event_classes, xlim=c(1,17))
mtext("Eagle", side=1, line=3, at=1.5)
...
\begin{table}[h!]\small
    ...
    \begin{tabular}{ll}
        ...
        \hspace{5mm} Garfoot: & \Sexpr{ paste(names(gs$ranked), collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ paste(names(ks$ranked), collapse=", ") }
    \vspace{2mm}\\
        \textbf{Phosphorus} & \\
        ...
        \hspace{5mm} Garfoot: & \Sexpr{ paste(names(gp$ranked), collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ paste(names(kp$ranked), collapse=", ") }\\
    \end{tabular}
...
\begin{table}[h!]\small
    ...
    \begin{tabular}{ll}
        ...
        \hspace{5mm} Garfoot: & \Sexpr{ paste(names(gs_snow$ranked), collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ paste(names(ks_snow$ranked), collapse=", ") }
    \vspace{2mm}\\
        \textbf{Phosphorus} & \\
        ...
        \hspace{5mm} Garfoot: & \Sexpr{ paste(names(gp_snow$ranked), collapse=", ") }\\
        \hspace{5mm} Kuenster: & \Sexpr{ paste(names(kp_snow$ranked), collapse=", ") }\\
    \end{tabular}
