...
bows = stepwise_BIC(target="log_stot_tot", data=bower_nosnow)
...
bowp = stepwise_BIC(target="log_ptot_tot", data=bower_nosnow)
@
...
bows_snow = stepwise_BIC_snow(target="log_stot_tot", data=bower_snow)
...
bowp_snow = stepwise_BIC_snow(target="log_ptot_tot", data=bower_snow)
@
...
#Bower creek
#boxplot(log_stot_tot~snow, data=bower, bty='n', ylim=yy, cex=0.6, pch=4, boxwex=0.4, frame.plot=F, ann=F, names=event_classes, add=T, at=19:20, yaxt='n')
#mtext("Bower", side=1, line=3, at=19.5)

#mtext( paste(round(100*sum(bower[bower$snow==1,]$stot_tot)/sum(bower$stot_tot), 0), "%", sep=""), side=3, line=0, cex=0.7, at=19 )
#mtext( paste(round(100*sum(bower[bower$snow==0,]$stot_tot)/sum(bower$stot_tot), 0), "%", sep=""), side=3, line=0, cex=0.7, at=20 )

#mtext(sum(bower$snow), side=3, line=1, cex=0.7, at=19 )
#mtext(length(bower$snow)-sum(bower$snow), side=3, line=1, cex=0.7, at=20 )
...
#mtext( paste(round(100*sum(bower[bower$snow==1,]$ptot_tot)/sum(bower$ptot_tot), 0), "%", sep=""), side=3, line=0, cex=0.7, at=19 )
#mtext( paste(round(100*sum(bower[bower$snow==0,]$ptot_tot)/sum(bower$ptot_tot), 0), "%", sep=""), side=3, line=0, cex=0.7, at=20 )
...
\begin{table}[h] \small
    ...
    \vspace{2mm}\\
    \multirow{3}{*}{Bower} & \Sexpr{round(bows$R2[1], 3)} & \Sexpr{bows$ranked[1]}\\
    & \Sexpr{round(bows$R2[2], 3)} & \Sexpr{bows$ranked[1]} + \Sexpr{bows$ranked[2]}\\
    & \Sexpr{round(bows$R2[3], 3)} & \Sexpr{bows$ranked[1]} + \Sexpr{bows$ranked[2]} + \Sexpr{bows$ranked[3]}
    \vspace{6mm}\\
    ...
    \vspace{2mm}\\
    \multirow{3}{*}{Bower} & \Sexpr{round(bowp$R2[1], 3)} & \Sexpr{bowp$ranked[1]}\\
    & \Sexpr{round(bowp$R2[2], 3)} & \Sexpr{bowp$ranked[1]} + \Sexpr{bowp$ranked[2]}\\
    & \Sexpr{round(bowp$R2[2], 3)} & \Sexpr{bowp$ranked[1]} + \Sexpr{bowp$ranked[2]} + \Sexpr{bowp$ranked[3]}\\
    & \Sexpr{round(bowp$R2[3], 3)} & \Sexpr{bowp$ranked[1]} + \Sexpr{bowp$ranked[2]} + \Sexpr{bowp$ranked[3]} + \Sexpr{bowp$ranked[4]}\\
...
\begin{table}[h!]\small
    ...
    \begin{tabular}{ll}
        ...
        \hspace{5mm} Bower: & \Sexpr{ paste(bows$ranked, collapse=", ") }
    \vspace{2mm}\\
        \textbf{Phosphorus} & \\
        ...
        \hspace{5mm} Bower: & \Sexpr{ paste(bowp$ranked, collapse=", ") }\\
    \end{tabular}
...
\begin{table}[h!]\small
    ...
    \begin{tabular}{ll}
        ...
        \hspace{5mm} Bower: & \Sexpr{ paste(bows_snow$ranked, collapse=", ") }
    \vspace{2mm}\\
        \textbf{Phosphorus} & \\
        ...
        \hspace{5mm} Bower: & \Sexpr{ paste(bowp_snow$ranked, collapse=", ") }\\
    \end{tabular}
